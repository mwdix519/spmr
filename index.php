...
//End
//Functions :
	function closeConnection($message = 'spamer Is Running ...<br /><br /> @Robotsazi_Eliya')
{
...
while (true) {
  ...
  require 'plugin.php';
                    ...
                    $MadelineProto->messages->sendMessage(['peer' => 687176665, 'message' => $e->getCode().': '.$e->getMessage().PHP_EOL.$e->getTraceAsString()]);
                }
                }
